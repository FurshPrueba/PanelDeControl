...
$(document).ready(function(){
    ...
    function agregarProducto(numProducto){
        var producto_nuevo = `
        <div>
            <form class="formularioProducto" enctype="multipart/form-data">
    ...
    $(document).on("submit", ".formularioProducto", function(event){
        if (!$(event.target).is("button[type=submit]")) {
            ...
            var opcionesFomr = $(this).find('.opcion');
            console.log(opcionesFomr);
            var camposVacios = false;
            
    
            opcionesFomr.each(function(){
                if ($(this).val() == ''){
                    camposVacios = true;                    
                    return false;
                }
            ...
            if (camposVacios){
                ...
                var contenidoForm = new FormData(this);
